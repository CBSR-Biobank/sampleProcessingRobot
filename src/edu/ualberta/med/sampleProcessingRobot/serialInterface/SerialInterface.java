 ...
 * 
 *         A simple wrapper for the java serial library (here supplied by gnu's
 *         RXTX)
 * 
 *         Provides basic communication to and from the serial port, as well as
 *         some useful related methods
 * 
 */
public class SerialInterface {
    ...
    /**
     * Reads an array of bytes from the serial buffer, returning as many as are
     * available in the buffer, up to the size of dest.
     * 
